...
void BoardWidget::addStone(go::node* node, const go::point& sp, const go::point& bp, go::color c){
    go::node* stoneNode = node->isStone() ? new go::node(node) : node;
